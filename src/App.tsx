...
function AppContent() {
  ...
  // Show Maintenance page  // عرض صفحة الصيانة فقط إذا تم تفعيلها يدوياً من الباك إند
  if (isMaintenanceMode) {
    return <Maintenance />;
  }

  // إذا كان السيرفر متوقفاً، اظهر الموقع الطبيعي (سيكون فارغاً من البيانات ولكن لن يظهر بلوك الصيانة)
  if (isBackendOffline) {
    console.warn("Backend is offline, showing normal layout as requested.");
  }
